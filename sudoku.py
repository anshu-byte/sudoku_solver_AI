...
while True:
    ...
    #Reason for selecting adaptive threshold because variable lightning condtion 
    ...
    #for quadrilateral shape detection
    for c in contours:
    ...
    if contour_grille is not None:
        ...
        #Perspective Transformation and then warp
